          ...
          <div className="HomeTeamMainBox">
            ...
            <div className="OurTeamDetailsBox">
              ...
              <div className="LearnMoreOurTeam">
                <p>
                  Dr. Anandhu K is a highly experienced pharmacology educator
                  with over 8+ years of teaching and clinical expertise. He has
                  guided thousands of students in preparing for DHA, MOH, HAAD,
                  SPLE, and Prometric exams with a proven track record of
                  success.
                </p>
              </div>
